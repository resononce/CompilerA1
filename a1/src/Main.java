...
public class Main {
	...
	for (int i = 0; i < args.length; i++) {
		...
		System.err.println("Usage error: bad input file name: "
				   + args[i]);
		System.err.println(
    ...
    /** Main method, which drives compilation
      * builds and runs the lexer only (for this assigment)
      * @param args list of commandline arguments 
      * */
	...
	try {
	    Lexer lexer = new Lexer(inFiles, false);
	    lexer.scanAndPrintTokens();
	}
